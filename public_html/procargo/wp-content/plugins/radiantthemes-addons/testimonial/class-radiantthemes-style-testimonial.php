...
if ( class_exists( 'WPBakeryShortCode' ) && ! class_exists( 'Radiantthemes_Style_Testimonial' ) ) {
	...
	class Radiantthemes_Style_Testimonial extends WPBakeryShortCode {
				...
				array(
					...
					'params'      => array(
						array(
							...
							'value'      => array(
								esc_html__( 'Style One (Bottom Left Image - Light)', 'radiantthemes-addons' )   => 'one',
		...
		public function radiantthemes_testimonial_style_func( $atts, $content = null, $tag ) {
			...
			$custom_css .= $shortcode['testimonial_color'] ? '.testimonial.element-one.' . $random_class . ' .testimonial-item > .holder > .testimonial-data:before,
            .testimonial.element-one.' . $random_class . ' .testimonial-item > .holder > .testimonial-title > .testimonial-title-data .designation,
