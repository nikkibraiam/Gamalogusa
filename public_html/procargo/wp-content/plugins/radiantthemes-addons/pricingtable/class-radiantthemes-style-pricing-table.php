	...
	class Radiantthemes_Style_Pricing_Table extends WPBakeryShortCode {
					...
					'params'      => array(
						array(
							...
							'value'       => array(
								...
								esc_html__( 'Style Two (Modern Flat)', 'radiantthemes-addons' )  => 'two',
							),
							'std'         => 'one',
							'admin_label' => true,
						),
		...
		public function radiantthemes_pricing_table_style_func( $atts, $content = null, $tag ) {
			...
			if($shortcode['pricing_table_color']) {
                ...
                .rt-pricing-table.element-two.{$random_class} > .holder > .pricing .title,
                ...
                .rt-pricing-table.element-two.{$random_class} > .holder:hover > .pricing,
