				...
				array(
					...
					'params'      => array(
						array(
							...
							'value'      => array(
								esc_html__( 'Style One (Classic Name and Title Below With Overlay Excerpt)', 'radiantthemes-addons' )  => 'one',
								esc_html__( 'Style Two (Boxed Shadow Name and Title Below)', 'radiantthemes-addons' )                  => 'two',
							),
							'std'        => 'one',
						),
						array(
