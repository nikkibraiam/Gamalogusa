	...
	class RadiantThemes_Style_Fancy_Text_Box extends WPBakeryShortCode {
				...
				array(
					...
					'params'      => array(
						array(
							...
							'value'       => array(
								esc_html__( 'Style One (Image Background with FadeIn Overlay)', 'radiantthemes-addons' )             => 'one',
								esc_html__( 'Style Two (Classic with Circle Icon)', 'radiantthemes-addons' )                         => 'two',
								esc_html__( 'Style Three (Shadow with Hover Fill Color Center)', 'radiantthemes-addons' )            => 'three',
								esc_html__( 'Style Four (Classic with Cloud Background Icon)', 'radiantthemes-addons' )              => 'four',
								esc_html__( 'Style Five (Shadow with Hover Fill Color Left Icon)', 'radiantthemes-addons' )          => 'five',
								esc_html__( 'Style Six (Top Large Image With Classic Content)', 'radiantthemes-addons' )             => 'six',
								esc_html__( 'Style Seven (Top Large Image With Shadowed Content Box)', 'radiantthemes-addons' )      => 'seven',
								esc_html__( 'Style Eight (Top Large Image With Content Box Hover Shadow)', 'radiantthemes-addons' )  => 'eight',
								esc_html__( 'Style Nine (Top Icon Circular With Content Box Shadow)', 'radiantthemes-addons' )       => 'nine',
								esc_html__( 'Style Ten (Top Icon With Hover Shadow)', 'radiantthemes-addons' )                       => 'ten',
							),
							'std'         => 'one',
							'admin_label' => true,
						),
		...
		public function radiantthemes_fancy_text_box_style_func( $atts, $content = null, $tag ) {
			...
			if ( ! empty( $shortcode['fancy_textbox_color'] ) ) {
				// CUSTOM CSS.
				$custom_css = "
				.rt-fancy-text-box.element-two.{$random_class} > .holder:hover .heading .title,
				.rt-fancy-text-box.element-four.{$random_class} > .holder:hover .heading .title{
					color: {$shortcode['fancy_textbox_color']} ;
				}
				.rt-fancy-text-box.element-three.{$random_class} > .holder:hover,
				.rt-fancy-text-box.element-five.{$random_class} > .holder:hover,
				.rt-fancy-text-box.element-seven.{$random_class} > .holder:hover > .data{
					background-color: {$shortcode['fancy_textbox_color']} ;
				}
				.rt-fancy-text-box.element-nine.{$random_class} > .holder:hover > .pic-image,
				.rt-fancy-text-box.element-nine.{$random_class} > .holder:hover > .pic-icon{
