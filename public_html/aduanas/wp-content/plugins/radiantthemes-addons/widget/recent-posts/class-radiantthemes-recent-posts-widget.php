...
class Radiantthemes_Recent_Posts_Widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			esc_html__( 'RadiantThemes Recent Posts With Thumbnail Widget', 'finacia' ),
			// Widget description.
			array(
				'description' => esc_html__( 'Widget for recent posts.', 'finacia' ),
			)
		);
	}
	...
	public function widget( $args, $instance ) {
		...
		$maxpoststitle = ! empty( $instance['maxpoststitle'] ) ? $instance['maxpoststitle'] : esc_html__( 'RECENT POSTS', 'finacia' );
		$maxposts      = ! empty( $instance['maxposts'] ) ? $instance['maxposts'] : esc_html__( '4', 'finacia' );
		?>
	...
	public function form( $instance ) {
		...
		?>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'maxpoststitle' ) ); ?>"><?php esc_html_e( 'Title:', 'finacia' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'maxposts' ) ); ?>"><?php esc_html_e( 'No. of Posts to show:', 'finacia' ); ?></label>
