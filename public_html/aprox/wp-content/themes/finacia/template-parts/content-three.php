	...
	<div class="row">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			<div class="post-thumbnail">
				<img src="<?php echo esc_url( get_parent_theme_file_uri( '/images/No-Image-Found-400x264.png' ) ); ?>" alt="<?php echo esc_attr__( 'No Image Found', 'finacia' ); ?>" width="400" height="264">
