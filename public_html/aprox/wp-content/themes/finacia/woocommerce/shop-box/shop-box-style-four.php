...
<div <?php post_class( 'radiantthemes-shop-box matchHeight style-four' ); ?>>
	<div class="holder">
		...
		<?php } ?>
		<div class="pic">
			<img src="<?php echo esc_url( get_parent_theme_file_uri( '/assets/images/blank/Blank-Image-100x123.png' ) ); ?>" alt="<?php echo esc_attr__( 'Blank Image', 'finacia' ); ?>" width="100" height="123">
